    ...
    <table align="center" width="650px" cellspacing="0" cellpadding="0" style="max-width: 650px;width:650px; margin:20px 0; border: 1px solid #CECECE;padding:15px;">
        <tbody>
                ...
                <tr style="background:#212B5F;padding: 35px 20px;">
                    <td style="text-transform: uppercase;font-size: 25px;font-weight: 600;color: #fff;font-family: 'Montserrat', sans-serif;">Total Paid Amount</td>
                    <td></td>
                    <td style="font-size: 24px;color: #fff;font-weight:700;font-family: 'Montserrat', sans-serif;" class="last-price">$<?= $body['total'];?></td>
                </tr>
