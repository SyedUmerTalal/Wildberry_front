          ...
          <div class="col-md-6">
            <form role="form" action="<?php echo $action;?>" method="post" enctype="multipart/form-data">       
              ...
              <div class="form-group">
                ...
                <select rows="6" class="form-control"  id="category_id" name="hdng">
              ...
              <?php } else { ?>              
               ...
               <div class="form-group">
                <label>Category Name as Banner Heading</label>
                <select rows="6" class="form-control"  id="category_id" name="hdng">
                  <option selected disabled>Select Category</option>
                  <?php foreach($cat as $data):?>
                  <option value="<?= $data->category_id;?>" <?= $data->category_id == $record->hdng ? 'selected' : '' ?>><?= $data->category_name;?></option>
                <?php endforeach;?>
                </select>
                <?php echo form_error('category_id'); ?>
              </div>
              ...
              <?php } ?>
                ...
                <div class="form-group">
                  <label>Text</label>
                  <textarea type="name" class="form-control" id="txt" name="txt" required><?php echo !empty($record->txt)?$record->txt:''?></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group-btn">
                    <div class="image-upload">                      
                      <img src="<?php echo !empty($record->img2)?base_url('uploads/homebnr/').$record->img2:base_url('assets/admin/img/placeholder.png')?>">
                      <div class="file-btn">
