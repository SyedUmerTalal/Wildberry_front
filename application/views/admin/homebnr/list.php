            ...
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>            
                ...
                <tr>
                  ...
                  <td><?php echo !empty($record->txt)?$record->txt:'';?></td>
                 
                  <td><?php echo !empty($record->img1)?'<img src="'.base_url('uploads/homebnr/').$record->img1.'" height="50">':'';?></td>
                  <td><?php echo !empty($record->img2)?'<img src="'.base_url('uploads/homebnr/').$record->img2.'" height="50">':'';?></td>
                  <td>
