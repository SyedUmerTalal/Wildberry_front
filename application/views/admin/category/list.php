            ...
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>            
                ...
                <tr>
                  ...
                  <td><?php echo !empty($record->feature)?$record->feature:'';?></td>
                 
                 <td><?php echo !empty($record->category_image)?'<img src="'.base_url('uploads/category/').$record->category_image.'" height="50">':'';?></td>
                  <td>
