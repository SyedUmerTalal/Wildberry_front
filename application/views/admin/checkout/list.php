            ...
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>            
                ...
                <tr>
                  ...
                  <td><button type="button" class="btn btn-primary reserve_table" data-toggle="modal" data-target="#remarksmodal" data-id="<?= $record->checkout_id;?>" data-whatever="@mdo">Remarks</button></td>
