          ...
          <div class="col-md-12">
              <div class="box-body box-body-view">
                ...
                <?php endif;?>
                 ...
                 <?php if(!empty($record->cod)):?>
                  <div class="form-group clearfix">
                      <span class="col-md-2 view_label">Order Type</span>
                      <span class="col-md-10 view_details"><?php echo $record->cod;?></span>
                  </div>  
                <?php endif;?>
                
                 <?php if(!empty($record->cod_amount)):?>
                  <div class="form-group clearfix">
                      <span class="col-md-2 view_label">COD Amount</span>
                      <span class="col-md-10 view_details"><?php echo $record->cod_amount;?></span>
                  </div>  
                <?php endif;?>
