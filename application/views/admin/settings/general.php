            ...
            <form role="form" action="<?php echo base_url('admin/settings/general');?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">
                <div class="form-group">
                  <label>Map Radius in KM</label>
                  <input type="name" class="form-control" id="map_radius" name="map_radius" value="<?php echo !empty($record->map_radius)?$record->map_radius:''?>" >
                  <?php echo form_error('map_radius'); ?>
                </div>
                <div class="form-group">
