              ...
              <div class="box-body box-body-view">
                ...
                <?php if(!empty($record->full_name)):?>
                  <div class="form-group clearfix">
                      ...
                      <span class="col-md-10 view_details"><?php echo $record->full_name;?></span>
                  </div>  
                <?php endif;?>
                ...
                <?php endif;?>
                 ...
                 <?php if(!empty($record->subject)):?>
                  <div class="form-group clearfix">
                      <span class="col-md-2 view_label">Subject</span>
                      <span class="col-md-10 view_details"><?php echo $record->subject;?></span>
                  </div>  
                <?php endif;?>
