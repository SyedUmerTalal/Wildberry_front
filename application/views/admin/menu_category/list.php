      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">  
            <a href="<?php echo site_url('admin/'.$table_name.'/create');?>" class="btn btn-success"><i class="fa fa-plus"></i> Add New</a>
          </div>  
          <div class="box-body">
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>            
                ...
                <tr>
                  ...
                  <td><?php echo !empty($record->category_id)?get_value_by_id('category', $record->category_id, 'category_name'):'';?></td>
                  <td><?php echo !empty($record->menu_category_name)?$record->menu_category_name:'';?></td>
                  <td><?php echo !empty($record->menu_category_thumbnail)?'<img src="'.base_url('uploads/product/').$record->menu_category_thumbnail.'" height="50">':'';?></td>
                  <td>
                    <a href="<?php echo !empty($record->$record_id)?base_url('admin/'.$table_name.'/edit/').$record->$record_id:'';?>"><span class="edit_icon"><i class="fa fa-pencil" aria-hidden="true"></i></span></a>
